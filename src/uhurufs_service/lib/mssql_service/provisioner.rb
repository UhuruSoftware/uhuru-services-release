...
class VCAP::Services::Uhurufs::Provisioner < VCAP::Services::Base::Provisioner
  include VCAP::Services::Uhurufs::Common

  def create_snapshot_job
    VCAP::Services::Uhurufs::Snapshot::CreateSnapshotJob
  end

  def rollback_snapshot_job
    VCAP::Services::Uhurufs::Snapshot::RollbackSnapshotJob
  end
  ...
  def import_from_url_job
    VCAP::Services::Uhurufs::Serialization::ImportFromURLJob
  end
